    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure system preferences, policies, and appearance</p>
        </div>
      </div>
      ...
      {hasChanges && (
        <div className="fixed bottom-4 right-4 rounded-lg border bg-background p-4 shadow-lg z-50">
